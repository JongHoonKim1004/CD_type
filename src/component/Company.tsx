      ...
      <div className='container'>
        ...
        <div className='row'>
          <div className='col-md-2' style={{height: "240px", paddingBottom: "50px"}}>
            <img alt='' src='img/Company/company_BS1.jpg' style={{width: "100%", height: "100%", border: "1px solid #999"}} />
          </div>
        ...
        <div className='row'>
          <div className='col-md-2' style={{height: "240px", paddingBottom: "50px"}}>
            <img alt='' src='img/Company/company_BS2.jpg' style={{width: "100%", height: "100%", border: "1px solid #999"}} />
          </div>
          <div className='col-md-10' style={{paddingLeft: "30px", lineHeight: "20px"}}>
        ...
        <div className='row'>
          <div className='col-md-2' style={{height: "240px", paddingBottom: "50px"}}>
            <img alt='' src='img/Company/company_BS3.jpg' style={{width: "100%", height: "100%", border: "1px solid #999"}} />
          </div>
          <div className='col-md-10' style={{paddingLeft: "30px", lineHeight: "20px"}}>
